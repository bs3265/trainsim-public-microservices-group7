...
export default class CheckoutPage extends Component<CheckoutPageProps, CheckoutPageState> {
    ...
    createOrder  = async () => {
        ...
        const response = await axios.post('http://localhost:8004/api/order', orderDetail);
        return response;
    }
    ...
    override render() {
        ...
        return <div>
            ...
            <NavButtonBar
                onBack={() => setPage(<TravelerInfoPage search={search} search_return={search} itinerary_return={itinerary} roundTrip={false} itinerary={itinerary} setPage={setPage} />)}
